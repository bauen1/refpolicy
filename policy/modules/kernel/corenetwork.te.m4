...
netifcon $2 gen_context(system_u:system_r:$1,$3) gen_context(system_u:system_r:unlabeled_t,$3)
...
nodecon $3 $4 gen_context(system_u:system_r:$1,$2)
...
portcon $2 $3 gen_context(system_u:system_r:$1,$4)
...
ibpkeycon $2 $3 gen_context(system_u:system_r:$1,$4)
...
ibendportcon $2 $3 gen_context(system_u:system_r:$1,$4)
